...
<footer
	...
	class="bg-base-200 text-base-content mt-auto py-8">
	<div class="flex flex-col md:flex-row justify-between items-center">
		<div class="mb-4 md:mb-0">
			<div class="flex items-center">
				...
				<span class="font-semibold text-lg">Recipe App</span>
			</div>
			<p class="text-sm mt-1">Discover, save, and share your favorite recipes</p>
		</div>
		...
		<div class="flex flex-wrap justify-center gap-4 mb-4 md:mb-0">
			...
			<a
				href="/about"
				class="hover:text-primary transition-colors {$page.url.pathname === '/about'
					? 'text-primary'
					: ''}">
				About
			</a>
			<a
				href="/contact"
				class="hover:text-primary transition-colors {$page.url.pathname === '/contact'
					? 'text-primary'
					: ''}">
				Contact
			</a>
